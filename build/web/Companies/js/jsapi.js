(function() {/* Copyright The Closure Library Authors. SPDX-License-Identifier: Apache-2.0 */
    ...
    S.Qc("Promise", function(b) {
        ...
        function e(h) {
            return h instanceof c ? h : new c(function(m) {
                m(h)
            })
        }
        if (b && !S.ek)
        ...
        c.prototype.Sn = function(h) {
            if (h === this)
                this.mf(new TypeError("A Promise cannot resolve to itself"));
        ...
        c.prototype.ej = function(h, m) {
            if (this.qa != g.Wa)
                throw Error("Cannot settle(" + h + ", " + m + "): Promise already settled in state" + this.qa);
            this.qa = h;
            this.Ga = m;
            this.Ul()
        };
        ...
        c.race = function(h) {
            return new c(function(m, n) {
                for (var v = S.Ed(h), J = v.next(); !J.done; J = v.next())
                    e(J.value).fd(m, n)
            })
        };
        c.all = function(h) {
            var m = S.Ed(h), n = m.next();
            return n.done ? e([]) : new c(function(v, J) {
                ...
                var M = [], R = 0;
                do
                    M.push(void 0), R++, e(n.value).fd(za(M.length - 1), J), n = m.next();
                while (!n.done)
            })
        };
        return c
    ...
    T.gh = function(b, c, d) {
        ...
        for (var e; b.length && (e = b.shift()); )
            b.length || void 0 === c ? d = d[e] && d[e] !== Object.prototype[e] ? d[e] : d[e] = {} : d[e] = c
    };
    ...
    T.module = function(b) {
        if (typeof b !== I || !b || -1 == b.search(T.Qk))
    ...
    T.Gi = function(b) {
        ...
        try {
            ...
            if (T.Sa(b))
                ...
                T.Oo() && (b = T.To(b)), d = T.hn.call(void 0, b);
            else
                throw Error("Invalid module definition");
            var e = T.Da.Nc;
            if (typeof e === I && e)
                T.Da.Be ? T.Ug(e, d) : T.Fk && Object.seal && typeof d == F && null != d && Object.seal(d), T.Hi[e] = {exports: d, type: T.tc.he, vn: T.Da.Nc};
            else
    ...
    T.ra = function(b) {
        ...
        if (c == F)
            if (b) {
                ...
                return"null";
        else if (c == w && "undefined" == typeof b.call)
            return F;
        return c
    };
    ...
    T.now = T.me && Date.now || function() {
        return+new Date
    };
    T.Xu = function(b) {
        if (T.global.execScript)
            T.global.execScript(b, "JavaScript");
            ...
            if (T.od)
                ...
                var c = T.global.document, d = c.createElement(sa);
                d.type = ua;
                d.defer = !1;
    ...
    T.Ka.Bg = function(b, c) {
        ...
        for (var e = 0; e < T.Ka.ig.length; e++)
            d = T.Ka.ig[e], Object.prototype.hasOwnProperty.call(c, d) && (b[d] = c[d])
    };
    T.zx = O();
    ...
    T.Ad = Ba();
    T.Yg = function(b) {
        var c = null, d = T.global.trustedTypes || T.global.TrustedTypes;
        if (!d || !d.createPolicy)
            return c;
        try {
    ...
    T.i.j.zo = /%%%%/g;
    T.i.j.Zv = function(b) {
        return b.replace(T.i.j.Ll, ":$1 $4 $3 $2").replace(T.i.j.an, "%%%%").replace(T.i.j.Un, T.i.j.Yc).replace(T.i.j.zo, T.i.j.$c)
    };
    T.i.j.Nl = /([\u0591-\u05f2])"/g;
    T.i.j.ro = /([\u0591-\u05f2])'/g;
    T.i.j.dw = function(b) {
    ...
    T.debug.Error = function(b) {
        if (Error.captureStackTrace)
            Error.captureStackTrace(this, T.debug.Error);
        else {
            var c = Error().stack;
            c && (this.stack = c)
        }
    ...
    T.m.Ws = function() {
        for (var b in Object.prototype)
            T.m.va(b + " should not be enumerable in Object.prototype.")
    };
    T.m.Th = function(b) {
    ...
    T.g.Rv = T.g.An;
    T.g.indexOf = T.bb && (T.g.$a || Array.prototype.indexOf) ? function(b, c, d) {
        return Array.prototype.indexOf.call(b, c, d)
    } : function(b, c, d) {
        d = null == d ? 0 : 0 > d ? Math.max(0, b.length + d) : d;
        if (typeof b === I)
            return typeof c !== I || 1 != c.length ? -1 : b.indexOf(c, d);
        for (; d < b.length; d++)
            if (d in b && b[d] === c)
                return d;
        return-1
    ...
    T.g.lastIndexOf = T.bb && (T.g.$a || Array.prototype.lastIndexOf) ? function(b, c, d) {
        ...
        if (typeof b === I)
            return typeof c !== I || 1 != c.length ? -1 : b.lastIndexOf(c, d);
        for (; 0 <= d; d--)
            if (d in b && b[d] === c)
                return d;
        return-1
    };
    T.g.forEach = T.bb && (T.g.$a || Array.prototype.forEach) ? function(b, c, d) {
    ...
    T.g.nh = function(b, c) {
        var d = b.length, e = typeof b === I ? b.split("") : b;
        for (--d; 0 <= d; --d)
    ...
    T.g.map = T.bb && (T.g.$a || Array.prototype.map) ? function(b, c, d) {
        return Array.prototype.map.call(b, c, d)
    } : function(b, c, d) {
        for (var e = b.length, f = Array(e), g = typeof b === I ? b.split("") : b, k = 0; k < e; k++)
            k in g && (f[k] = c.call(d, g[k], k, b));
        return f
    };
    T.g.reduce = T.bb && (T.g.$a || Array.prototype.reduce) ? function(b, c, d, e) {
        e && (c = T.bind(c, e));
    ...
    T.g.reduceRight = T.bb && (T.g.$a || Array.prototype.reduceRight) ? function(b, c, d, e) {
        e && (c = T.bind(c, e));
    ...
    T.g.every = T.bb && (T.g.$a || Array.prototype.every) ? function(b, c, d) {
    ...
    T.g.Wl = function(b, c, d) {
        var e = b.length, f = typeof b === I ? b.split("") : b;
        for (--e; 0 <= e; e--)
    ...
    T.g.Ib = function(b, c) {
        if (!T.la(b) || !T.la(c) || b.length != c.length)
            return!1;
    ...
    T.c.A.trim = T.me && String.prototype.trim ? function(b) {
        return b.trim()
    } : function(b) {
    ...
    T.c.A.Fa = function(b, c) {
        if (c)
            b = b.replace(T.c.A.Ff, "&amp;").replace(T.c.A.fg, "&lt;").replace(T.c.A.ag, "&gt;").replace(T.c.A.mg, "&quot;").replace(T.c.A.og, "&#39;").replace(T.c.A.hg, "&#0;");
        else {
            if (!T.c.A.Cj.test(b))
                return b;
    ...
    T.object.extend = function(b, c) {
        for (var d, e, f = 1; f < arguments.length; f++) {
            ...
            for (d in e)
                b[d] = e[d];
            for (var g = 0; g < T.object.lg.length; g++)
                d = T.object.lg[g], Object.prototype.hasOwnProperty.call(e, d) && (b[d] = e[d])
        }
    };
    T.object.create = function(b) {
        var c = arguments.length;
        if (1 == c && Array.isArray(arguments[0]))
            return T.object.create.apply(null, arguments[0]);
        if (c % 2)
            throw Error(da);
    ...
    T.object.Cl = function(b) {
        var c = arguments.length;
        if (1 == c && Array.isArray(arguments[0]))
            return T.object.Cl.apply(null, arguments[0]);
        for (var d = {}, e = 0; e < c; e++)
            d[arguments[e]] = !0;
        return d
    };
    ...
    T.h.userAgent.B.Mi = function() {
        return T.h.userAgent.K.S("Safari") && !(T.h.userAgent.B.df() || T.h.userAgent.B.ef() || T.h.userAgent.B.Li() || T.h.userAgent.B.ff() || T.h.userAgent.B.Ji() || T.h.userAgent.B.Ki() || T.h.userAgent.B.gf() || T.h.userAgent.B.xi() || T.h.userAgent.K.S("Android"))
    };
    T.h.userAgent.B.ef = function() {
        return T.h.userAgent.K.S("Coast")
    };
    T.h.userAgent.B.un = function() {
        return(T.h.userAgent.K.S("iPad") || T.h.userAgent.K.S("iPhone")) && !T.h.userAgent.B.Mi() && !T.h.userAgent.B.df() && !T.h.userAgent.B.ef() && !T.h.userAgent.B.gf() && T.h.userAgent.K.S("AppleWebKit")
    };
    ...
    T.h.userAgent.B.Ic = function() {
        ...
        if (T.h.userAgent.B.Bd())
            return T.h.userAgent.B.jm(c);
    ...
    T.ma && (T.c.F.prototype.toString = function() {
        return"Const{" + this.zf + "}"
    });
    T.c.F.D = function(b) {
        if (b instanceof T.c.F && b.constructor === T.c.F && b.Jk === T.c.F.rg)
            return b.zf;
    ...
    T.ma && (T.b.V.prototype.toString = function() {
    ...
    T.b.V.sj = function(b) {
        if (b instanceof T.b.V && b.constructor === T.b.V && b.Ak === T.b.V.ua)
            return b.Kd;
    ...
    T.da.url.lh = function() {
        return void 0 !== T.global.URL && void 0 !== T.global.URL.createObjectURL ? T.global.URL : void 0 !== T.global.webkitURL && void 0 !== T.global.webkitURL.createObjectURL ? T.global.webkitURL : void 0 !== T.global.createObjectURL ? T.global : null
    };
    ...
    T.ma && (T.b.I.prototype.toString = function() {
    ...
    T.b.I.Xd = function(b) {
        if (b instanceof T.b.I && b.constructor === T.b.I && b.Mk === T.b.I.ua)
            return b.kf;
    ...
    T.ma && (T.b.s.prototype.toString = function() {
        return"SafeUrl{" + this.jf + "}"
    });
    T.b.s.D = function(b) {
        if (b instanceof T.b.s && b.constructor === T.b.s && b.Dk === T.b.s.ua)
            return b.jf;
    ...
    T.b.s.pf = function(b, c, d) {
        (b = b.exec(c)) ? (b = b[1], -1 == (d instanceof T.c.F ? [T.c.F.D(d)] : d.map(function(e) {
            return T.c.F.D(e)
        })).indexOf(b) && (c = T.b.s.oa)) : c = T.b.s.oa;
        return T.b.s.ya(c)
    };
    T.b.s.yu = function(b) {
    ...
    T.b.s.Oa = function(b, c) {
        if (b instanceof T.b.s)
            return b;
        b = typeof b == F && b.Ra ? b.Ea() : String(b);
        if (c && /^data:/i.test(b) && (c = T.b.s.Zl(b), c.Ea() == b))
            return c;
        T.b.le.test(b) || (b = T.b.s.oa);
        return T.b.s.ya(b)
    };
    ...
    T.ma && (T.b.G.prototype.toString = function() {
        return"SafeStyle{" + this.Md + "}"
    });
    T.b.G.D = function(b) {
        if (b instanceof T.b.G && b.constructor === T.b.G && b.Ck === T.b.G.ua)
            return b.Md;
    ...
    T.b.G.Zi = function(b) {
        if (b instanceof T.b.s)
            return'url("' + T.b.s.D(b).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")';
        b = b instanceof T.c.F ? T.c.F.D(b) : T.b.G.eo(String(b));
        if (/[{;}]/.test(b))
            throw new T.m.pc("Value does not allow [{;}], got: %s.", [b]);
        return b
    };
    T.b.G.eo = function(b) {
        ...
        if (T.b.G.Rk.test(c)) {
            if (T.b.G.Sj.test(b))
                return T.m.va("String value disallows comments, got: " + b), T.b.G.oa;
            if (!T.b.G.xm(b))
                return T.m.va("String value requires balanced quotes, got: " + b), T.b.G.oa;
            if (!T.b.G.ym(b))
                return T.m.va("String value requires balanced square brackets and one identifier per pair of brackets, got: " + b), T.b.G.oa
        } else
            return T.m.va("String value allows only " + T.b.G.wg + " and simple functions, got: " + b), T.b.G.oa;
        return T.b.G.fo(b)
    };
    T.b.G.xm = function(b) {
    ...
    T.b.X.wm = function(b) {
        for (var c = {"(": ")", "[": "]"}, d = [], e = 0; e < b.length; e++) {
            ...
            if (c[f])
                d.push(c[f]);
            else if (T.object.contains(c, f) && d.pop() != f)
                return!1
        }
        return 0 == d.length
    };
    ...
    T.ma && (T.b.X.prototype.toString = function() {
        return"SafeStyleSheet{" + this.Ld + "}"
    });
    T.b.X.D = function(b) {
        if (b instanceof T.b.X && b.constructor === T.b.X && b.Bk === T.b.X.ua)
            return b.Ld;
    ...
    T.ma && (T.b.u.prototype.toString = function() {
    ...
    T.b.u.yb = function(b) {
        if (b instanceof T.b.u && b.constructor === T.b.u && b.yk === T.b.u.ua)
            return b.Jd;
        T.m.va("expected object of type SafeHtml, got '" + b + a + T.ra(b));
        return"type_error:SafeHtml"
    };
    T.b.u.Fa = function(b) {
        if (b instanceof T.b.u)
            return b;
        var c = typeof b == F, d = null;
        c && b.Xe && (d = b.tb());
    ...
    T.b.u.Ro = function(b) {
        if (!T.b.u.vg.test(b))
            throw Error(T.b.u.Ua ? "Invalid tag name <" + b + ">." : "");
        if (b.toUpperCase()in T.b.u.sk)
            throw Error(T.b.u.Ua ? "Tag name <" + b + "> is not allowed for SafeHtml." : "");
    };
    ...
    T.b.u.Dt = function(b, c, d, e) {
        if (!T.b.u.ul())
            throw Error(T.b.u.Ua ? "The browser does not support sandboxed iframes." : "");
        var f = {};
    ...
    T.b.u.createScript = function(b, c) {
        for (var d in c) {
            ...
            if ("language" == e || "src" == e || "text" == e || "type" == e)
                throw Error(T.b.u.Ua ? 'Cannot set "' + e + '" attribute' : "");
        }
        d = "";
        b = T.g.concat(b);
        for (e = 0; e < b.length; e++)
    ...
    T.b.u.am = function(b, c, d) {
        if (d instanceof T.c.F)
            d = T.c.F.D(d);
        else if ("style" == c.toLowerCase())
            if (T.b.u.Kk)
                d = T.b.u.qm(d);
            else
                throw Error(T.b.u.Ua ? 'Attribute "style" not supported.' : "");
        else {
            if (/^on/i.test(c))
                throw Error(T.b.u.Ua ? 'Attribute "' + c + '" requires goog.string.Const value, "' + d + '" given.' : "");
            if (c.toLowerCase()in T.b.u.Ok)
                if (d instanceof T.b.I)
                    d = T.b.I.D(d);
                else if (d instanceof T.b.s)
                    d = T.b.s.D(d);
                else if (typeof d === I)
                    d = T.b.s.Rd(d).Ea();
                else
                    throw Error(T.b.u.Ua ? 'Attribute "' + c + '" on tag "' + b + '" requires goog.html.SafeUrl, goog.string.Const, or string, value "' + d + '" given.' : "");
        }
        d.Ra && (d = d.Ea());
    ...
    T.b.u.qm = function(b) {
        if (!T.Ba(b))
            throw Error(T.b.u.Ua ? 'The "style" attribute requires goog.html.SafeStyle or map of style properties, ' + typeof b + " given: " + b : "");
    ...
    T.b.u.wo = function(b, c) {
        ...
        if (c)
            for (var e in c) {
                if (!T.b.u.vg.test(e))
                    throw Error(T.b.u.Ua ? 'Invalid attribute name "' + e + '".' : "");
                var f = c[e];
    ...
    T.b.u.kd = function(b, c, d) {
        ...
        if (d)
            for (f in d) {
                var g = f.toLowerCase();
                if (g in b)
                    throw Error(T.b.u.Ua ? 'Cannot override "' + g + '" attribute, got "' + f + '" with value "' + d[f] + '"' : "");
                g in c && delete e[g];
                e[f] = d[f]
            }
        return e
    ...
    T.a.N.sf = function(b, c) {
        if (T.m.xa && T.a.N.Gk[b.tagName.toUpperCase()])
    ...
    T.c.Ri = function(b, c, d) {
        ...
        for (var e = b.toLowerCase().match(d), f = c.toLowerCase().match(d), g = Math.min(e.length, f.length), k = 0; k < g; k++) {
            ...
            var h = f[k];
            if (d != h)
                return b = parseInt(d, 10), !isNaN(b) && (c = parseInt(h, 10), !isNaN(c) && b - c) ? b - c : d < h ? -1 : 1
        }
    ...
    T.c.repeat = String.prototype.repeat ? function(b, c) {
        return b.repeat(c)
    } : function(b, c) {
    ...
    T.h.userAgent.ca.Ic = function() {
        ...
        if (b) {
            ...
            if (c)
                return"Gecko" == c[0] ? T.h.userAgent.ca.tm(b) : c[1];
            b = b[0];
            var d;
    ...
    T.h.userAgent.ca.tm = function(b) {
        return(b = T.g.find(b, function(c) {
            return"Firefox" == c[0]
        })) && b[1] || ""
    };
    ...
    T.userAgent.Ta = function(b) {
        return T.userAgent.Dj || T.hb.cache(T.userAgent.Ym, b, function() {
    ...
    T.C.Wv = function(b, c, d, e) {
        ...
        for (h = 1; h <= f; h++)
            for (m = 1; m <= g; m++)
                d(b[h - 1], c[m - 1]) ? k[h][m] = k[h - 1][m - 1] + 1 : k[h][m] = Math.max(k[h - 1][m], k[h][m - 1]);
        var n = [];
        h = f;
        for (m = g; 0 < h && 0 < m; )
            d(b[h - 1], c[m - 1]) ? (n.unshift(e(h - 1, m - 1)), h--, m--) : k[h - 1][m] > k[h][m - 1] ? h-- : m--;
        return n
    };
    T.C.Af = function(b) {
        return T.g.reduce(arguments, function(c, d) {
            return c + d
        }, 0)
    };
    T.C.ll = function(b) {
    ...
    T.C.co = function(b) {
        ...
        return T.C.Af.apply(null, T.g.map(arguments, function(e) {
    ...
    T.ma && (T.C.ha.prototype.toString = function() {
    ...
    T.ma && (T.C.Vb.prototype.toString = function() {
    ...
    T.a.qd = function(b, c, d, e) {
        ...
        if (d) {
            e = {};
            for (g = f = 0; k = b[g]; g++)
                c = k.className, typeof c.split == w && T.g.contains(c.split(/\s+/), d) && (e[f++] = k);
            e.length = f;
            return e
        }
        return b
    ...
    T.a.Ud = function(b, c) {
        T.object.forEach(c, function(d, e) {
            ...
            "style" == e ? b.style.cssText = d : "class" == e ? b.className = d : "for" == e ? b.htmlFor = d : T.a.Uf.hasOwnProperty(e) ? b.setAttribute(T.a.Uf[e], d) : T.c.startsWith(e, "aria-") || T.c.startsWith(e, "data-") ? b.setAttribute(e, d) : b[e] = d
        })
    };
    ...
    T.a.uh = function(b) {
        return T.a.ga.Oj && void 0 != b.children ? b.children : T.g.filter(b.childNodes, function(c) {
    ...
    T.a.contains = function(b, c) {
        if (!b || !c)
            return!1;
        if (b.contains && c.nodeType == T.a.sa.kb)
    ...
    T.a.Qg = function(b, c) {
        ...
        if (T.userAgent.na && !T.userAgent.Lc(9)) {
            if (b.nodeType == T.a.sa.Vc)
                return-1;
            if (c.nodeType == T.a.sa.Vc)
                return 1
        }
        if ("sourceIndex"in b || b.parentNode && "sourceIndex"in b.parentNode) {
            var d = b.nodeType == T.a.sa.kb, e = c.nodeType == T.a.sa.kb;
            if (d && e)
                return b.sourceIndex - c.sourceIndex;
            var f = b.parentNode, g = c.parentNode;
            return f == g ? T.a.Sg(b, c) : !d && T.a.contains(f, c) ? -1 * T.a.Rg(b, c) : !e && T.a.contains(g, b) ? T.a.Rg(c, b) : (d ? b.sourceIndex : f.sourceIndex) - (e ? c.sourceIndex : g.sourceIndex)
        }
        e = T.a.ub(b);
        d = e.createRange();
        d.selectNode(b);
    ...
    T.a.tf = function(b, c) {
        if ("textContent"in b)
            ...
            T.a.nf(b), b.appendChild(T.a.ub(b).createTextNode(String(c)))
    };
    T.a.Kh = function(b) {
        if ("outerHTML"in b)
            return b.outerHTML;
    ...
    T.a.Ee = function(b, c, d, e) {
        if (null != b)
            for (b = b.firstChild; b; ) {
                if (c(b) && (d.push(b), e) || T.a.Ee(b, c, d, e))
                    return!0;
                b = b.nextSibling
            }
        return!1
    ...
    T.a.ud = function(b) {
        if (T.a.ga.Sf && null !== b && "innerText"in b)
            b = T.c.wl(b.innerText);
        else {
            var c = [];
            T.a.Ue(b, c, !0);
            b = c.join("")
    ...
    T.a.Ue = function(b, c, d) {
        if (!(b.nodeName in T.a.qg))
            if (b.nodeType == T.a.sa.ad)
                d ? c.push(String(b.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : c.push(b.nodeValue);
            else if (b.nodeName in T.a.Zc)
                c.push(T.a.Zc[b.nodeName]);
            else
                for (b = b.firstChild; b; )
                    T.a.Ue(b, c, d), b = b.nextSibling
    };
    T.a.Ih = function(b) {
        ...
        for (var e = 0, f = null; 0 < b.length && e < c; )
            if (f = b.pop(), !(f.nodeName in T.a.qg))
                if (f.nodeType == T.a.sa.ad) {
                    ...
                    e += g.length
                } else if (f.nodeName in T.a.Zc)
                    e += T.a.Zc[f.nodeName].length;
                else
    ...
    T.a.af = function(b) {
        if (b && typeof b.length == E) {
            if (T.Ba(b))
                return typeof b.item == w || typeof b.item == I;
            if (T.Sa(b))
                return typeof b.item == w
        }
        return!1
    };
    ...
    T.a.Ru = function() {
        var b = T.a.cc();
        return void 0 !== b.devicePixelRatio ? b.devicePixelRatio : b.matchMedia ? T.a.Fd(3) || T.a.Fd(2) || T.a.Fd(1.5) || T.a.Fd(1) || .75 : 1
    };
    T.a.Fd = function(b) {
    ...
    T.debug.pa.register = function(b) {
        ...
        if (T.debug.pa.Qi)
            for (var c = T.debug.pa.hf, d = 0; d < c.length; d++)
                b(T.bind(c[d].Uo, c[d]))
    };
    T.debug.pa.aw = function(b) {
        T.debug.pa.Qi = !0;
        for (var c = T.bind(b.Uo, b), d = 0; d < T.debug.pa.jc.length; d++)
            T.debug.pa.jc[d](c);
    ...
    T.debug.pa.Nx = function(b) {
        var c = T.debug.pa.hf;
        b = T.bind(b.D, b);
        for (var d = 0; d < T.debug.pa.jc.length; d++)
            T.debug.pa.jc[d](b);
        c.length--
    };
    ...
    T.async.Ma.pm = function() {
        ...
        "undefined" === typeof b && "undefined" !== typeof window && window.postMessage && window.addEventListener && !T.h.userAgent.ca.Sm() && (b = function() {
            ...
            T.a.N.Ml(f);
            f.close();
            var k = "callImmediate" + Math.random(), h = "file:" == g.location.protocol ? "*" : g.location.protocol + "//" + g.location.host;
            f = T.bind(function(m) {
    ...
    T.async.cb.ee = 100;
    T.async.cb.Ec = new T.async.Xc(function() {
    ...
    T.Promise.ee = 100;
    T.Promise.Ec = new T.async.Xc(function() {
    ...
    function U(b, c, d) {
        b.qa == T.Promise.aa.Wa && (b === d && (c = T.Promise.aa.Ia, d = new TypeError("Promise cannot resolve to itself")), b.qa = T.Promise.aa.Lj, T.Promise.Oi(d, b.Ho, b.Io, b) || (b.Ga = d, b.qa = c, b.wa = null, La(b), c != T.Promise.aa.Ia || d instanceof T.Promise.Qb || T.Promise.Vk(b, d)))
    }
    T.Promise.Oi = function(b, c, d, e) {
        if (b instanceof T.Promise)
            return T.Promise.ab && Fa(b, Error("then")), Ka(b, T.Promise.sh(c || T.Mb, d || null, e)), !0;
        if (T.Thenable.ki(b))
        ...
        if (T.Ba(b))
            try {
                var f = b.then;
                if (T.Sa(f))
                    return T.Promise.Fo(b, f, c, d, e), !0
            } catch (g) {
                return d.call(e, g), !0
            }
        return!1
    ...
    T.Promise.prototype.Tl = function() {
        for (var b; b = Ia(this); )
            T.Promise.ab && this.$g++, Ja(this, b, this.qa, this.Ga);
        this.De = !1
    };
    function Ja(b, c, d, e) {
        if (d == T.Promise.aa.Ia && c.hc && !c.cd)
            if (0 < T.Promise.Bb)
                for (; b && b.Wd; b = b.wa)
                    T.global.clearTimeout(b.Wd), b.Wd = 0;
            else if (0 == T.Promise.Bb)
                for (; b && b.wd; b = b.wa)
                    b.wd = !1;
        if (c.Db)
            c.Db.wa = null, T.Promise.fi(c, d, e);
        else
            try {
    ...
    T.Promise.Vk = function(b, c) {
        ...
        }, T.Promise.Bb) : 0 == T.Promise.Bb && (b.wd = !0, T.async.W(function() {
    ...
    Q.cancel = function(b) {
        if (this.Zb)
            this.Ga instanceof T.async.L && this.Ga.cancel();
        else {
            if (this.wa) {
                var c = this.wa;
                delete this.wa;
    ...
    function Oa(b) {
        ...
        for (var c = b.Ga, d = !1, e = !1; b.Td.length && !b.se; ) {
            var f = b.Td.shift(), g = f[0], k = f[1];
            f = f[2];
            if (g = b.ec ? k : g)
                try {
                    var h = g.call(f || b.dh, c);
                    void 0 !== h && (b.ec = b.ec && (h == c || h instanceof Error), b.Ga = c = h);
                    if (T.Thenable.ki(c) || typeof T.global.Promise === w && c instanceof T.global.Promise)
                        e = !0, b.se = !0
                } catch (m) {
        ...
        b.Ga = c;
        e ? (e = T.bind(b.Vg, b, !0), h = T.bind(b.Vg, b, !1), c instanceof T.async.L ? (V(c, e, h), c.pl = !0) : c.then(e, h)) : T.async.L.Ik && c instanceof Error && !(c instanceof T.async.L.Pb) && (d = b.ec = !0);
    ...
    T.M.O.mc = function(b, c) {
        ...
        var e = T.b.I.D(b), f = T.a.createElement(ca), g = {aj: f, oj: void 0}, k = new T.async.L(T.M.O.vl, g), h = null, m = null != d.timeout ? d.timeout : T.M.O.Xj;
    ...
    T.M.O.Hw = function(b, c, d) {
        ...
        var e = T.global[T.M.O.ge], f = T.b.I.D(b);
        if (void 0 !== e[c])
            return T.async.L.va(new T.M.O.Error(T.M.O.Wc.Tk, "Verification object " + c + " already defined."));
        b = T.M.O.mc(b, d);
    ...
    google.v.w.ia.Ci = function() {
        return new Promise(function(b) {
            if ("undefined" == typeof window || "complete" === document.readyState)
                ...
                document.addEventListener("DOMContentLoaded", b, !0), window.addEventListener("load", b, !0);
    ...
    google.v.w.Ha.load = function(b, c) {
        var d = T.b.I.format(b, c), e = T.M.O.mc(d, {timeout: google.v.w.Ha.nj, attributes: {async: !1, defer: !1}});
    ...
    google.v.w.Ha.Uv = function(b) {
        ...
        var c = {timeout: google.v.w.Ha.nj, attributes: {async: !1, defer: !1}}, d = [];
        !T.userAgent.na || T.userAgent.Ta(11) ? T.g.forEach(b, function(e) {
            d.push(T.M.O.mc(e, c))
        }) : d.push(T.M.O.ao(b, c));
        return Promise.all(T.g.map(d, function(e) {
            return new Promise(function(f) {
                return Ra(e, f)
            })
        }))
    ...
    T.o.ea = function(b) {
        if (b instanceof T.o.Iterator)
            return b;
        if (typeof b.pe == w)
            return b.pe(!1);
        if (T.la(b)) {
            var c = 0, d = new T.o.Iterator;
            d.next = function() {
                for (; ; ) {
                    if (c >= b.length)
                        throw T.o.ta;
    ...
    T.o.product = function(b) {
        if (T.g.some(arguments, function(f) {
            return!f.length
        }) || !arguments.length)
            return new T.o.Iterator;
        var c = new T.o.Iterator, d = arguments, e = T.g.repeat(0, d.length);
        c.next = function() {
            if (e) {
                for (var f = T.g.map(e, function(k, h) {
                    return d[h][k]
                }), g = e.length - 1; 0 <= g; g--) {
                    if (e[g] < d[g].length - 1) {
                        e[g]++;
    ...
    T.o.xj = function(b) {
        var c = arguments, d = new T.o.Iterator;
        if (0 < c.length) {
    ...
    T.o.Vo = function(b, c) {
        var d = T.g.slice(arguments, 1), e = new T.o.Iterator;
        if (0 < d.length) {
            var f = T.g.map(d, T.o.ea);
            e.next = function() {
                var g = !1, k = T.g.map(f, function(h) {
                    try {
                        var m = h.next();
                        g = !0
                    } catch (n) {
    ...
    T.o.ie.prototype.next = function() {
        for (; this.zc == this.kj; )
            this.ld = this.iterator.next(), this.zc = this.Fi(this.ld);
    ...
    T.o.tee = function(b, c) {
        ...
        var e = T.o.ea(b), f = T.g.map(T.g.Pd(typeof c === E ? c : 2), function() {
            return[]
        });
    ...
    Q.Gb = function(b) {
        for (var c = 0; c < this.Z.length; c++) {
            var d = this.Z[c];
            if (T.P.Map.Kb(this.Ca, d) && this.Ca[d] == b)
                return!0
        }
        return!1
    };
    ...
    function W(b) {
        ...
        if (b.Y != b.Z.length) {
            ...
            for (d = c = 0; c < b.Z.length; )
                e = b.Z[c], T.P.Map.Kb(f, e) || (b.Z[d++] = e, f[e] = 1), c++;
            b.Z.length = d
        }
    }
    Q.get = function(b, c) {
    ...
    Q.pe = function(b) {
        W(this);
        var c = 0, d = this.Tc, e = this, f = new T.o.Iterator;
        f.next = function() {
            if (d != e.Tc)
    ...
    T.P.forEach = function(b, c, d) {
        if (b.forEach && typeof b.forEach == w)
            b.forEach(c, d);
        else if (T.la(b) || typeof b === I)
            T.g.forEach(b, c, d);
        else
    ...
    T.P.filter = function(b, c, d) {
        if (typeof b.filter == w)
            return b.filter(c, d);
        if (T.la(b) || typeof b === I)
            return T.g.filter(b, c, d);
        var e = T.P.ka(b), f = T.P.fa(b), g = f.length;
        if (e) {
            var k = {};
            for (var h = 0; h < g; h++)
    ...
    T.P.map = function(b, c, d) {
        if (typeof b.map == w)
            return b.map(c, d);
        if (T.la(b) || typeof b === I)
            return T.g.map(b, c, d);
        var e = T.P.ka(b), f = T.P.fa(b), g = f.length;
        if (e) {
            var k = {};
            for (var h = 0; h < g; h++)
                k[e[h]] = c.call(d, f[h], e[h], b)
        } else
            for (k = [], h = 0; h < g; h++)
                k[h] = c.call(d, f[h], void 0, b);
        return k
    };
    T.P.some = function(b, c, d) {
        if (typeof b.some == w)
            return b.some(c, d);
        if (T.la(b) || typeof b === I)
            return T.g.some(b, c, d);
        for (var e = T.P.ka(b), f = T.P.fa(b), g = f.length, k = 0; k < g; k++)
            if (c.call(d, f[k], e && e[k], b))
                return!0;
        return!1
    };
    ...
    T.uri.l.qe = function(b, c, d) {
        if (Array.isArray(c))
            for (var e = 0; e < c.length; e++)
                T.uri.l.qe(b, String(c[e]), d);
        else
            null != c && d.push(b + ("" === c ? "" : "=" + T.c.Sc(c)))
    };
    T.uri.l.Kg = function(b, c) {
        var d = [];
        for (c = c || 0; c < b.length; c += 2)
            T.uri.l.qe(b[c], b[c + 1], d);
        return d.join("&")
    };
    ...
    T.uri.l.pd = function(b, c, d, e) {
        for (var f = d.length; 0 <= (c = b.indexOf(d, c)) && c < e; ) {
            ...
            if (g == T.uri.l.sc.Ef || g == T.uri.l.sc.tk)
                if (g = b.charCodeAt(c + f), !g || g == T.uri.l.sc.EQUAL || g == T.uri.l.sc.Ef || g == T.uri.l.sc.ik)
                    return c;
            c += f + 1
        }
        return-1
    ...
    T.uri.l.Ou = function(b, c) {
        var d = b.search(T.uri.l.yd), e = T.uri.l.pd(b, 0, c, d);
        if (0 > e)
            return null;
        var f = b.indexOf("&", e);
        if (0 > f || f > d)
    ...
    T.J = function(b, c) {
        ...
        this.La = this.Tm = !1;
        var d;
        b instanceof T.J ? (this.La = void 0 !== c ? c : b.La, Ua(this, b.Hc()), Va(this, b.vd()), Wa(this, b.Gc()), Xa(this, b.td()), this.Rc(b.ac()), Ya(this, b.Te().clone()), Za(this, b.rd())) : b && (d = T.uri.l.split(String(b))) ? (this.La = !!c, Ua(this, d[T.uri.l.T.Ub] || "", !0), Va(this, d[T.uri.l.T.ne] || "", !0), Wa(this, d[T.uri.l.T.jb] || "", !0), Xa(this, d[T.uri.l.T.mb]), this.Rc(d[T.uri.l.T.je] || "", !0), Ya(this, d[T.uri.l.T.ke] || "", !0), Za(this, d[T.uri.l.T.Yf] || "", !0)) : (this.La = !!c, this.Na = new T.J.Ya(null, this.La))
    };
    ...
    Q.toString = function() {
        ...
        var d = this.Gc();
        if (d || "file" == c)
            b.push("//"), (c = this.vd()) && b.push(T.J.Cc(c, T.J.Ti, !0), "@"), b.push(T.J.Ui(T.c.Sc(d))), d = this.td(), null != d && b.push(":", String(d));
        if (d = this.ac())
            this.fb && "/" != d.charAt(0) && b.push("/"), b.push(T.J.Cc(d, "/" == d.charAt(0) ? T.J.Fn : T.J.In, !0));
        (d = this.Na.toString()) && b.push("?", d);
        (d = this.rd()) && b.push("#", T.J.Cc(d, T.J.Gn));
        return b.join("")
    };
    Q.resolve = function(b) {
        var c = this.clone(), d = !!b.nc;
        d ? Ua(c, b.Hc()) : d = !!b.Cf;
        d ? Va(c, b.vd()) : d = !!b.fb;
    ...
    function Y(b) {
        b.ba || (b.ba = new T.P.Map, b.Y = 0, b.Ja && T.uri.l.zn(b.Ja, function(c, d) {
            b.add(T.c.Yd(c), d)
        }))
    }
    ...
    Q.fa = function(b) {
        ...
        var c = [];
        if (typeof b === I)
            this.Fb(b) && (c = T.g.concat(c, this.ba.get(Z(this, b))));
        else {
            b = this.ba.fa();
            for (var d = 0; d < b.length; d++)
                c = T.g.concat(c, b[d])
    ...
    Q.extend = function(b) {
        for (var c = 0; c < arguments.length; c++)
            T.P.forEach(arguments[c], function(d, e) {
                this.add(e, d)
            }, this)
    };
    google.v.w.H = {};
    ...
    google.v.w.H.jn = function(b) {
        var c = google.v.w.Uj.On[google.v.w.H.fb].loader, d = google.v.w.H.rn(b);
    ...
    google.v.w.H.Gi = function(b, c, d) {
        ...
        if (!e)
            throw Error('Module "' + b + '" is not supported.');
        var f = e.aliases;
        c = function(h) {
            var m;
            do {
        ...
        var g = google.v.w.H.hk, k = {module: b, version: c || "", file: e.versions[c].compressed};
